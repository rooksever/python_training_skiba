...
'''datetime_s = '0000-00-00 00:00:00'
print(datetime)
datetime_o = datetime.strptime(datetime_s, '%Y-%m-%d %H:%M:%S')'''
...
class ORMFixture:
    ...
    def convert_contacts_to_model(self, contacts):
        def convert(contact):
            return Contact(contact_id=str(contact.contact_id), first_name=contact.first_name,
